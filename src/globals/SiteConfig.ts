    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'openaiModel', type: 'text', defaultValue: 'gpt-4o',
          admin: { description: 'OpenAI model ID for chat responses (e.g. gpt-4o, gpt-4o-mini)' } },
        ...
        { name: 'maxMessagesPerSession', type: 'number', defaultValue: 50,
          admin: { description: 'Maximum messages per chat session before auto-close' } },
      ],
    },
    {
      name: 'search',
