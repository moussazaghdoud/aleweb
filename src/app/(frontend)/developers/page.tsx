  ...
  return (
    <>
      ...
      <section className="relative min-h-[420px] flex items-end overflow-hidden">
        <Image src="https://web-assets.al-enterprise.com/-/media/assets/internet/images/solutions-digital-age-networking-homepage-header-l2-l3-1440x600.jpg?h=600&w=1440" alt="Developers" fill className="object-cover animate-ken-burns" priority sizes="100vw" />
            ...
            {[
              ...
              <div key={s.step} className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-lg bg-ale-50 flex items-center justify-center shrink-0">
                  <span className="text-ale font-bold text-sm">{s.step}</span>
                </div>
                <div>
                  <h3 className="text-sm font-bold text-text mb-1">{s.title}</h3>
