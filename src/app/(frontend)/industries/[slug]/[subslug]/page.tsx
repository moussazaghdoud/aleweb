...
export default async function IndustrySubPage({
  ...
  const { cta: ctaStyle } = await searchParams;
  ...
  return (
    <>
      ...
      <section className="relative min-h-[440px] flex items-end overflow-hidden">
        <video autoPlay muted loop playsInline aria-hidden="true" className="absolute inset-0 w-full h-full object-cover"><source src={industrySubPageVideos[`${slug}/${subslug}`] || industryVideos[slug] || "https://assets.mixkit.co/videos/4547/4547-720.mp4"} type="video/mp4" /></video>
        ...
        <div className="relative mx-auto max-w-[1320px] px-6">
          <div className="flex flex-col lg:flex-row gap-14 items-start">
            ...
            <div className="lg:w-1/3 lg:sticky lg:top-24">
              {/* ── CTA Box — style variants (use ?cta=A|B|C|D|E to preview) ── */}

              {/* A — Glass card */}
              {ctaStyle === "A" && (
                <div className="bg-white/60 backdrop-blur-xl border border-gray-200/60 rounded-2xl p-7 shadow-lg">
                  <div className="w-10 h-10 rounded-xl bg-ale/10 flex items-center justify-center mb-4">
                    <svg className="w-5 h-5 text-ale" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.354 0-2.694-.055-4.02-.163a2.115 2.115 0 01-.825-.242m9.345-8.334a2.126 2.126 0 00-.476-.095 48.64 48.64 0 00-8.048 0c-1.131.094-1.976 1.057-1.976 2.192v4.286c0 .837.46 1.58 1.155 1.951m9.345-8.334V6.637c0-1.621-1.152-3.026-2.76-3.235A48.455 48.455 0 0011.25 3c-2.115 0-4.198.137-6.24.402-1.608.209-2.76 1.614-2.76 3.235v6.226c0 1.621 1.152 3.026 2.76 3.235.577.075 1.157.14 1.74.194V21l4.155-4.155" /></svg>
                  </div>
                  <h3 className="text-base font-bold text-gray-900 mb-2">Ready to get started?</h3>
                  <p className="text-sm text-gray-500 mb-5 leading-relaxed">Talk to our {parent.name.toLowerCase()} specialists about a tailored solution.</p>
                  <Link href="/company/contact" className="inline-flex items-center gap-2 h-11 px-6 bg-ale text-white text-sm font-semibold rounded-full hover:bg-ale-dark transition-colors w-full justify-center">
                    Contact Sales
              ...
              {/* B — Soft gradient */}
              {ctaStyle === "B" && (
                <div className="bg-gradient-to-br from-slate-800 to-indigo-900 rounded-2xl p-7 text-white shadow-xl">
              ...
              {/* C — White + accent bar */}
              {ctaStyle === "C" && (
                <div className="relative bg-white border border-gray-100 rounded-2xl p-7 shadow-lg overflow-hidden">
                  <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-gradient-to-b from-ale via-ale to-purple-500" />
                  <div className="pl-3">
                    <div className="w-10 h-10 rounded-xl bg-ale-50 flex items-center justify-center mb-4">
                      <svg className="w-5 h-5 text-ale" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.354 0-2.694-.055-4.02-.163a2.115 2.115 0 01-.825-.242m9.345-8.334a2.126 2.126 0 00-.476-.095 48.64 48.64 0 00-8.048 0c-1.131.094-1.976 1.057-1.976 2.192v4.286c0 .837.46 1.58 1.155 1.951m9.345-8.334V6.637c0-1.621-1.152-3.026-2.76-3.235A48.455 48.455 0 0011.25 3c-2.115 0-4.198.137-6.24.402-1.608.209-2.76 1.614-2.76 3.235v6.226c0 1.621 1.152 3.026 2.76 3.235.577.075 1.157.14 1.74.194V21l4.155-4.155" /></svg>
                    </div>
                    <h3 className="text-base font-bold text-gray-900 mb-2">Ready to get started?</h3>
                    <p className="text-sm text-gray-500 mb-5 leading-relaxed">Talk to our {parent.name.toLowerCase()} specialists about a tailored solution.</p>
              ...
              {ctaStyle === "D" && (
                <div className="bg-gray-50 rounded-2xl p-7 shadow-sm">
                  ...
                  <h3 className="text-base font-bold text-gray-900 mb-2">Ready to get started?</h3>
                  <p className="text-sm text-gray-500 mb-5 leading-relaxed">Talk to our {parent.name.toLowerCase()} specialists about a tailored solution.</p>
                  <Link href="/company/contact" className="inline-flex items-center gap-2 h-11 px-6 bg-gradient-to-r from-ale to-purple-600 text-white text-sm font-semibold rounded-full hover:from-ale-dark hover:to-purple-700 transition-all w-full justify-center">
                    Contact Sales
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
                  </Link>
                </div>
              ...
              {/* E — Outlined (ale border) */}
              {ctaStyle === "E" && (
                <div className="bg-white border-2 border-ale/20 ring-1 ring-ale/10 rounded-2xl p-7 shadow-lg shadow-ale/5">
                  <div className="w-10 h-10 rounded-xl bg-ale-50 flex items-center justify-center mb-4">
                    <svg className="w-5 h-5 text-ale" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.354 0-2.694-.055-4.02-.163a2.115 2.115 0 01-.825-.242m9.345-8.334a2.126 2.126 0 00-.476-.095 48.64 48.64 0 00-8.048 0c-1.131.094-1.976 1.057-1.976 2.192v4.286c0 .837.46 1.58 1.155 1.951m9.345-8.334V6.637c0-1.621-1.152-3.026-2.76-3.235A48.455 48.455 0 0011.25 3c-2.115 0-4.198.137-6.24.402-1.608.209-2.76 1.614-2.76 3.235v6.226c0 1.621 1.152 3.026 2.76 3.235.577.075 1.157.14 1.74.194V21l4.155-4.155" /></svg>
                  </div>
                  <h3 className="text-base font-bold text-gray-900 mb-2">Ready to get started?</h3>
              ...
              {/* Default — current dark style (no ?cta param) */}
              {!ctaStyle && (
