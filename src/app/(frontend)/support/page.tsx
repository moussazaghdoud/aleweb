  ...
  return (
    <>
      ...
      <section className="relative min-h-[420px] flex items-end overflow-hidden">
        <Image src="https://web-assets.al-enterprise.com/-/media/assets/internet/images/support-homepage-header-l2-l3-1440x600.jpg?h=600&w=1440" alt="Support" fill className="object-cover animate-ken-burns" priority sizes="100vw" />
