...
export const metadata = {
  ...
  alternates: { canonical: "/customers/case-studies" },
  openGraph: {
    title: "Customer Stories | Alcatel-Lucent Enterprise",
    description: "See how organizations worldwide use ALE enterprise technology to transform their operations.",
  ...
  return (
    <>
      ...
      <section className="relative min-h-[420px] flex items-end overflow-hidden">
        <video autoPlay muted loop playsInline aria-hidden="true" className="absolute inset-0 w-full h-full object-cover"><source src={landingVideos.caseStudies} type="video/mp4" /></video>
