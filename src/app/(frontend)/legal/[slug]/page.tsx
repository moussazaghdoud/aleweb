  ...
  return (
    <>
      <section className="relative min-h-[420px] flex items-end overflow-hidden">
        <Image src="https://web-assets.al-enterprise.com/-/media/assets/internet/images/company-page-history-executive-homepage-header-l2-l3-1440x600-v3.jpg?h=600&w=1440" alt={page.name} fill className="object-cover animate-ken-burns" priority sizes="100vw" />
