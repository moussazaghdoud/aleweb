  ...
  return (
    <>
      ...
      <section className="relative min-h-[420px] flex items-end overflow-hidden">
        <video autoPlay muted loop playsInline aria-hidden="true" className="absolute inset-0 w-full h-full object-cover"><source src={productDetailVideos[category] || "https://assets.mixkit.co/videos/23215/23215-720.mp4"} type="video/mp4" /></video>
