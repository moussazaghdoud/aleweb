  ...
  return (
    <>
      ...
      <section className="relative min-h-[420px] flex items-end overflow-hidden">
        <Image src="https://web-assets.al-enterprise.com/-/media/assets/internet/images/product-switches-homepage-header-l2-l3-1440x600-web.jpg?h=600&w=1440" alt="Product catalog" fill className="object-cover animate-ken-burns" priority sizes="100vw" />
