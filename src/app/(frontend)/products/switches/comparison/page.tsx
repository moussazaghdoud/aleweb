...
import { switchComparison } from "@/data/product-comparisons";

export const metadata = {
  title: "OmniSwitch Comparison Tool | Products",
  description:
    "Compare specifications across the OmniSwitch portfolio. Side-by-side feature comparison for OS2260, OS2360, OS6360, OS6560, OS6860, OS6900, and OS9900.",
  alternates: {
    canonical: "/products/switches/comparison",
    languages: {
      en: "/products/switches/comparison",
      fr: "/fr/products/switches/comparison",
      "x-default": "/products/switches/comparison",
    },
  },
};

export default function SwitchComparisonPage() {
  const comparison = switchComparison;
      ...
      <section className="relative min-h-[340px] flex items-end overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-ale-dark">
        ...
        <div className="relative z-10 mx-auto max-w-[1320px] px-6 w-full pb-14 pt-40">
          ...
          <p className="mt-5 text-lg text-white/60 max-w-xl font-light leading-relaxed">
            Compare key specifications side by side across the full OmniSwitch
            portfolio to find the right switch for your network.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-light-50">
        <div className="mx-auto max-w-[1320px] px-6">
          ...
          <p className="text-sm text-text-muted mb-8">
            Compare key specifications across the switches portfolio
          </p>
              ...
              <thead>
                <tr className="border-b-2 border-light-200 bg-light-50">
                  ...
                  {comparison.products.map((name, i) => (
                    ...
                    >
                      <Link
                        href={`/products/switches/${comparison.productSlugs[i]}`}
      ...
      <section className="py-16 bg-ale">
        <div className="mx-auto max-w-[1320px] px-6 text-center">
          ...
          <p className="text-white/75 max-w-lg mx-auto mb-8">
            Our specialists can help you find the right switch for your
