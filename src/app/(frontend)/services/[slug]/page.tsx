  ...
  return (
    <>
      ...
      <section className="relative min-h-[440px] flex items-end overflow-hidden">
        <video autoPlay muted loop playsInline aria-hidden="true" className="absolute inset-0 w-full h-full object-cover"><source src={serviceVideos[slug] || "https://assets.mixkit.co/videos/4603/4603-720.mp4"} type="video/mp4" /></video>
